    ...
    <div style="padding: 5px 20px;">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item label="模块名称">
          <el-input v-model="selectdata.dataone" placeholder="psmName"></el-input>
        </el-form-item>
        <el-form-item>
      ...
      <el-table :data="list" element-loading-text="Loading" border fit highlight-current-row>
        <el-table-column label="模块名称" prop="psmName">
        </el-table-column>
        <el-table-column label="用途" prop="uses">
        </el-table-column>
      ...
      <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
        <el-form ref="collectionform" :rules="rules" :model="ruleForm" label-width="120px" label-position="left">
          <el-form-item label="模块名称" prop="psmName">
            <el-input placeholder="请输入模块名称" v-model="ruleForm.psmName"></el-input>
          </el-form-item>
          <el-form-item label="用途" prop="uses">
            <el-input placeholder="请输入用途" v-model="ruleForm.uses"></el-input>
          </el-form-item>
        </el-form>
    ...
    export default {
      ...
      methods: {
        ...
        onSubmitSelect() {
          // this.axiosdata()
          this.$axios({
            url: '/api/server/powerSystemModule/getScope',
            method: 'get',
                params:{
        ...
        axiosdata() {
          this.$axios({
            url: '/api/server/powerSystemModule/page',
            method: 'get',
                params:{
